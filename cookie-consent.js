<script>
    ...
    <div id="cc-box">
        ...
        <div id="view-banner" style="display:flex; flex-direction:column; height:100%;">
            <div class="cc-header">
                <h2>Privatsphäre</h2>
                <p>Wir verwenden Cookies, um die Nutzerfreundlichkeit zu verbessern und den Datenverkehr zu analysieren. Weitere Informationen finden Sie in unseren <a href="#" onclick="document.getElementById('btn-open-settings').click(); return false;">Einstellungen</a>.</p>
            </div>
            <div class="cc-scroll-area">
                ...
                <div style="text-align: center; font-size: 12px; color: #9ca3af; margin-top: 0px;">
                    <a href="${linkDatenschutz}" target="_blank">Datenschutz</a> •
                    <a href="${linkImpressum}" target="_blank">Impressum</a>
                </div>
            </div>
        </div>
                        ...
                        <div id="necessary-details" class="cc-details-content cc-hidden">
                            <div class="cc-cookie-info">
                                ...
                                <div class="cc-cookie-item">
                                    ...
                                    <p><strong>Datenschutz:</strong> <a href="${linkDatenschutz}" target="_blank">Plattform-Datenschutz</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
